...
is a markdown cell.`)
	...
	dc.Md("### Markdown cell")
	dc.Md("We add a markdown cell to our devcard with the following code:")
	...
	dc.Md("### Append")
	dc.Md("We may use `dc.Append` to append one or more piece to the bottom cell of our devcard:")
	code(dc,
		`dc.Md("This cell")
...
dc.Append("pieces.")`)
	...
	dc.Md("### HTML cell")
	dc.Md("When markdown doesn't cover our needs, we may drop down to an HTML cell:")
